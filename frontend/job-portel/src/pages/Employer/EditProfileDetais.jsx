                                        ...
                                        <div>
                                            <label className='block'>
                                                ...
                                                <input
                                                    ...
                                                    className='block w-full text-sm text-gray-500 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-green-50 file:text-green-700 hover:file:bg-green-100 transition-colors'
                                                />
                                            </label>
                                        </div>
                                    </div>
...
export default EditProfileDetais