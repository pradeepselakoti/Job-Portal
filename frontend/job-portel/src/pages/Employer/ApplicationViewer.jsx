  ...
  const fetchApplications = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        API_PATHS.APPLICATIONS.GETALL_APPLICATIONS(jobId)
      );
      setApplications(response.data)
    } catch (error) {
      console.log("Failed to fetch applicants",error)
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between'>
            <div className='flex items-center gap-4 mb-4 sm:mb-0'>
              <button
                ...
                className='group flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-600 hover:text-white bg-white/50 hover:bg-gradient-to-r hover:from-blue-500 hover:to-blue-600 border-gray-200 hover:border-transparent rounded-xl transition-all duration-300 shadow-lg shadow-gray-100 hover:shadow-xl'
              >
