...
const JobCard = ({ job, onClick, onToggleSave, onApply, saved, hideApply }) => {
    ...
    const formatSalary = (min, max) => {
        const formatNumber = (num) => {
            if (num >= 100) return `$${(num / 1000).toFixed(0)}k`;
            return `$${num}`;
        };
    ...
    >
        ...
        <div className="flex items-center justify-between text-xs font-medium text-gray-500 mb-5 pb-4 border-b border-gray-200">
