...
const JobPostingPreview = ({ formData, setIsPreview }) => {
    ...
    return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/20 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
            <div className="mb-8 backdrop-blur-sm bg-white/80 border border-white/20 shadow-xl rounded-2xl p-6">
                ...
                <div className="px-0 pb-8 space-y-8">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm md:text-lg font-bold text-gray-900">
                                            ...
                                            {parseInt(formData.salaryMin || 0).toLocaleString()} - {" "} {/* Added fallback for undefined */}
                                            {
                                                currencies.find(
                                                    (c) => c.value === formData.currency
                                                )?.label || "$"
                                            }
                                            {parseInt(formData.salaryMax || 0).toLocaleString()} {/* Added fallback for undefined */}
                    ...
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3"> {/* Fixed incomplete h3 tag and duplicate */}
                            <div className="w-1 h-8 bg-gradient-to-b from-blue-500 to-purple-600 rounded-full"></div> {/* Fixed w-1h-8 to w-1 h-8 */}
                            <span className="text-base md:text-lg">About This Role</span>
                        </h3>
                        <div className="bg-gray-50 border border-gray-100 rounded-xl p-6"> {/* Added missing border class */}
                    ...
                    <div className="space-y-4">
                        <h3 className="text-2xl font-bold text-gray-900 flex items-center space-x-3">
                            ...
                            <span className="text-base md:text-lg">What We're Looking For</span> {/* Fixed capitalization */}
                        </h3>
