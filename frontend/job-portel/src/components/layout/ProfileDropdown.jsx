       ...
       {isOpen && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border-gray-100 py-2 z-50">
             ...
             <button 
               ...
               className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors w-full text-left"
               >
                View Profile
             </button>
                <div className="border-t border-gray-100 mt-2 pt-2">
                    <button 
                    onClick={onLogout}
                    className="block px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors w-full text-left"
                    >
                        Sign out
                    </button>
                </div>
