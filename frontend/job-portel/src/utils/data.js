...
export const jobSeekerFeatures = [
  {
    ...
    description:
      "AI-powered algorithm matches you with relevant opportunities based on your skills and prefernce"
  },
  {
    icon: FileText,
    title: "Resume Builder",
    description:
      "Create professional resumes with our intuitive builder and templates designed ny experts"
  },
  {
    icon: MessageSquare,
    title: "Direct Communication",
    description:
      "Connect directly with hring managers and recuiters through our secure messaging platform",
  },
  {
    icon: Award,
    title: "Skill Assessment",
    description:
      "Showcase your abilities with verified skill and earn badges that employers trust"
  },
];
